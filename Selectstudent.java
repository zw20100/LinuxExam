...
public class Selectstudent extends HttpServlet {
    ...
    static final String DB_URL = "jdbc:mysql://123.60.5.124/stu";
    static final String USER = "root";
    static final String PASS = "Hzw@201003";
    static final String SQL_SELECT_STUDENT = "SELECT id, name, age FROM student WHERE id=?";
    static final String REDIS_URL = "123.60.5.124";
    ...
    public Student getStudent(int id) {
        ...
        try {
            stmt = conn.prepareStatement(SQL_SELECT_STUDENT);
            stmt.setInt(1, id);
